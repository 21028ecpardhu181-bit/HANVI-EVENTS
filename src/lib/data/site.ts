...
export const siteConfig: SiteConfig = {
  name: 'Hanvi Events',
  tagline: "God's Gift • All Function Events",
  mission: 'Founded and managed by Event Director Ch. Kala Prasad. Hanvi Events designs bespoke memories for weddings, mandap decorations, milestone celebrations, and corporate galas across Kakinada and coastal Andhra Pradesh.',
  founder: 'Ch. Kala Prasad',
  founderTitle: 'Founder & Event Director',
  phone: '+91 97009 29650',
  phoneRaw: '+919700929650',
  phoneNumbers: [
    { label: 'Primary Call', number: '+91 97009 29650', raw: '+919700929650' },
  ...
  stats: [
    {
      id: 'stat-1',
      label: 'Operational Heritage',
      value: '8+ Years',
      sublabel: 'Serving Kakinada & East Godavari',
    },
    {
      id: 'stat-2',
      label: 'Celebrations Managed',
      value: 'Hundreds',
      sublabel: 'Weddings, mandaps & galas',
    },
    {
      id: 'stat-3',
    ...
    },
    {
      ...
      value: '100%',
      sublabel: 'Personally directed by Ch. Kala Prasad',
    },
    {
      id: 'stat-5',
      label: 'Client Satisfaction',
      value: 'Verified',
      sublabel: 'Documented client testimonials',
    },
  ],
};
